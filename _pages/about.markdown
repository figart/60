...
### About Digett in Particular

My agency's focus had been, for the few years leading up to my epiphany of 2026, on managed service providers (MSPs) and other professional services firms. It's a niche that I thought might suit me given my fondness for computers and generally geeky interests. Honestly, though, I never felt like it was a great move, so I'd pretty much let the idea of Digett's specialization fade away. My work up to that point in my career, I felt, had been substantive. My clients had been smart. The problems had remained interesting enough to keep me engaged after two and a half decades of service. But dang, it was time to move on.

In February of 2026 I was still struggling with what I wanted my business to become. I was deriving way more satisfaction from being a Rotarian than I was from being an agency owner. And that's when the epiphany hit. What I love about being a Rotarian is that I can contribute to something meaningful while leveraging the power of the organization (Rotary International is everywhere and commands significant resources) to make an impact I couldn't otherwise. What if I simply turned my attention toward finding ways to apply my agency's abilities toward the problems faced by other organizations in the nonprofit and NGO space? If I can help an organization that helps others, then am I not impacting all their constituents through what I'm doing for the organization? 

At the same time I was getting super curious about what I was seeing happening under my nose regarding AI's ability to write code. It had been more than 20 years since I'd done any meaningful programming. But I had this inspiration in the form of the newly-electrified light bulb—this nonprofit focus—in my head. So I combined inspirations, and spent some time with this mysterious software called Claude Code to try and build a new website for Digett.

And I did just that. Little could I have anticipated the empowerment I found in a "partner" who could write code this fast and who could understand my instructions well enough to churn out one of the favorite websites I've ever authored, all in a week's time. I wanted to learn more, and I've been sitting down with AI for hours on end ever since that first week we coded together. Learning, building, solving problems. I'm more engaged with my work than I've been in 20 years. I'm taking this empowerment to mission-driven organizations so they can experience it, too.
...
In March 2025, I joined a convoy of Rotary volunteers who drive vehicles purchased with donated funds from London to Ukraine. We crossed the Channel, drove through France, Germany, and Poland, and delivered the vehicles directly to Ukrainians who needed them. I turned 60 somewhere along the way.
...
If you want to talk about AI, marketing, business, Ukraine, motorcycling, woodworking, or anything else, I'm easy to find:
